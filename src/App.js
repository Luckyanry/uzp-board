...
class App extends React.Component {
  constructor(props) {
    ...
    this.handleTreeViewSelectionChange =
      this.handleTreeViewSelectionChange.bind(this);
    this.handleTabPanelSelectionChange =
      this.handleTabPanelSelectionChange.bind(this);
  }
      ...
      <div className="container">
        ...
        <div className="right-content">
          <div className="title-container">
            <img className="flag" src={countryData.flag} alt="flag img" />
            <div>
...
function renderPanelItem(city) {
  return (
    <React.Fragment>
      <img className="flag" src={city.flag} alt="flag img" />
      <div className="right-content">
        <div>
